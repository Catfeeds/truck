        ...
        return(
          <View style = {{flex:1, backgroundColor:'#f0f0f0'}}>
            ...
            <View style = { styles.typeTool }>
              <TouchableOpacity style = { [styles.typeView, type == 3 && styles.typeViewSel] } onPress={ this.typeChange.bind(this, 3)}>
                <Text style = { [styles.type, type == 3 && styles.typeSel] }>推荐</Text>
              </TouchableOpacity>
              <TouchableOpacity style = { [styles.typeView, type == 1 && styles.typeViewSel] } onPress={ this.typeChange.bind(this, 1)}>
                <Text style = { [styles.type, type == 1 && styles.typeSel] }>海钓</Text>
              </TouchableOpacity>
              <TouchableOpacity style = { [styles.typeView, type == 2 && styles.typeViewSel] } onPress={ this.typeChange.bind(this, 2)}>
                <Text style = { [styles.type, type == 2 && styles.typeSel] }>海岛游</Text>
              </TouchableOpacity>
            </View>
            <SeaListView
              data = {datas}
