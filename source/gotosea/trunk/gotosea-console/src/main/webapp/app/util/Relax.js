Ext.define('Rich.util.Relax',{
	//alternateClassName: 'Rich.RelaxUtil',
	//singleton: true,
	/*放松间隙*/
	...
	_runRelax:function(){
		var me = Rich.RelaxUtil;//Relax目前只能是单态
		me.relaxId = 0;
    	...
    	if(len > 0)
    	{
    		...
    		console.error('Rich.relax不应该有空转');
    	}
	},
	/**
	 * 
	...
	var me = this;
	Rich.RelaxUtil = Rich.Relax = new me();
});