Ext.define('Rich.widget.CrudWindow',{
	requires:['Rich.util.Relax'],
    ...
    showByData:function(params){
    	this.show();
    	this.getComponent(0)._callback('o',true,params.data,'r')
    },
